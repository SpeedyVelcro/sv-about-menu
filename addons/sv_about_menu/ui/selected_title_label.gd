class_name SVAboutSelectedTitleLabel
extends Label
## Title [Label] for SV About Menu.
##
## Displays the title of the currently selected entry. You must set
